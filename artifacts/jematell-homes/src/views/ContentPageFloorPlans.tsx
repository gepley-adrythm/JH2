...
const FP_EXCLUSIVES: Record<string, ExclusiveCard[]> = {
  ...
  "2000-3000": [
    {
      slug: "2045",
      title: "The 2045 Plan",
      specs: ["2,045 Sq Ft", "2 Bedrooms", "2.5 Bathrooms", "2.5-Car + RV Garage"],
      desc: "A single-story home with a dedicated RV garage, available to build on your lot.",
  ...
  "over-3000": [
    ...
    },
    {
      slug: "3102",
      title: "The 3102 Plan",
      specs: ["3,102 Sq Ft", "4 Bedrooms", "3.5 Bathrooms", "1 Office", "2-Car Garage"],
    ...
    },
    {
      slug: "3610",
      title: "The 3610 Plan",
      specs: ["3,610 Sq Ft", "4 Bedrooms", "3.5 Bathrooms", "1 Study", "4-Car Garage + Shop"],
    ...
    },
    {
      slug: "3771",
      title: "The 3771 Plan",
      specs: ["3,771 Sq Ft", "3 Bedrooms", "4.5 Bathrooms", "1 Bonus + Den", "3-Car Garage"],
    ...
    },
    {
      slug: "4103",
      title: "The 4103 Plan",
      specs: ["4,103 Sq Ft", "3 Bedrooms", "4.5 Bathrooms", "1 Bonus + Den", "4-Car Garage"],

...
const DRAWINGS = [
  { label: "Floor Plan", src: "/images/plans/2086-1.png", alt: "2086 floor plan layout — 3 bedrooms plus office, 2 baths, 3-car garage" },
  { label: "Front & Left Elevations", src: "/images/plans/2086-2.png", alt: "2086 plan — front and left exterior elevations" },
  { label: "Rear & Right Elevations", src: "/images/plans/2086-3.png", alt: "2086 plan — rear and right exterior elevations" },
];
...
export default function FloorPlan2086({
  galleryImages = [],
}: {
  ...
  return (
    <MotionConfig reducedMotion="user">
      <main className="page" data-testid="page-floor-plan-2086">
        <section className="gallery-detail-hero">
          <picture className="gallery-detail-hero-picture">
            <img
              src="/images/plans/2086-rendering.png"
              alt="Rendered exterior elevation of the 2086 sq ft Jematell Homes floor plan"
          ...
          <div className="container page-hero-content gallery-detail-hero-content">
            <h1 className="page-hero-title hero-title">2086 Floor Plan</h1>
          </div>
        </section>

        <div className="fp1849-breadcrumb">
          <div className="container">
            <Link href="/floor-plans" className="fp1849-back" data-testid="fp2086-back">
          ...
          <div className="container">
            <div className="fp1849-stats-inner">
              <div className="fp1849-stat">
                <span className="fp1849-stat-value">2,086</span>
        ...
        <section className="section-pad fp1849-plan-section" style={{ paddingTop: "clamp(24px, 3vw, 40px)" }}>
          <div className="container">
            ...
            <m.p className="fp1849-plan-desc" {...FADE_IN}>This single-level home centers on an open great room, island kitchen, and dining space that share one bright, connected footprint and open to a covered patio for indoor-outdoor living. The owner's suite is tucked privately at the rear with its own bath and walk-in closet, while two secondary bedrooms and a full bath sit apart toward the front. A dedicated office off the foyer works equally well as a den or guest space, and a three-car garage gives you room for vehicles, a workshop, or desert toys.</m.p>
          ...
          <section className="fp1849-gallery-section alt-bg">
            <div className="container" style={{ paddingTop: "clamp(40px, 6vw, 80px)" }}>
              <m.div className="page-section-head centered" {...FADE_IN}>
                ...
                <p className="fp1849-gallery-body">The 2086 floor plan, built as our Desert Retreat home in Rio Verde, AZ.</p>
              </m.div>
            </div>
            ...
            <m.div className="fp1849-carousel" {...FADE_IN}>
              <button
                ...
                data-testid="fp2086-carousel-prev"
              >
                <ChevronLeft size={22} />
              </button>
              ...
              <button
                ...
                data-testid="fp2086-carousel-next"
              >
            ...
            <div className="container" style={{ paddingBottom: "clamp(40px, 6vw, 80px)" }}>
              <m.div style={{ textAlign: "center", marginTop: "32px" }} {...FADE_IN}>
                <Link
                  href="/gallery/desert-retreat"
                  className="btn btn-primary"
                  data-testid="fp2086-gallery-link"
                >
      ...
      {lightbox !== null && (
        ...
        >
          <button
            ...
            onClick={closeLightbox}
            aria-label="Close"
            data-testid="fp2086-lightbox-close"
          >
            <X size={22} />
          </button>
          <img

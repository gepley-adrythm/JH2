...
const DRAWINGS = [
  { label: "Floor Plan", src: "/images/plans/2194-1.png", alt: "2194 floor plan layout — 3 bedrooms plus office, 2 baths, 2-car plus RV garage" },
  { label: "Front & Left Elevations", src: "/images/plans/2194-2.png", alt: "2194 plan — front and left exterior elevations" },
  { label: "Right & Rear Elevations", src: "/images/plans/2194-3.png", alt: "2194 plan — right and rear exterior elevations" },
];
...
export default function FloorPlan2194({
  galleryImages = [],
}: {
  ...
  return (
    <MotionConfig reducedMotion="user">
      <main className="page" data-testid="page-floor-plan-2194">
        <section className="gallery-detail-hero">
          <picture className="gallery-detail-hero-picture">
            <img
              src="/images/plans/2194-rendering.png"
              alt="Rendered exterior elevation of the 2194 sq ft Jematell Homes floor plan"
          ...
          <div className="container page-hero-content gallery-detail-hero-content">
            <h1 className="page-hero-title hero-title">2194 Floor Plan</h1>
          </div>
        </section>

        <div className="fp1849-breadcrumb">
          <div className="container">
            <Link href="/floor-plans" className="fp1849-back" data-testid="fp2194-back">
          ...
          <div className="container">
            <div className="fp1849-stats-inner">
              <div className="fp1849-stat">
                <span className="fp1849-stat-value">2,194</span>
              ...
              <div className="fp1849-stat">
                ...
                <span className="fp1849-stat-label">Den/Office</span>
              </div>
              <div className="fp1849-stat-divider" />
              <div className="fp1849-stat">
                <span className="fp1849-stat-value">2 + RV</span>
        ...
        <section className="section-pad fp1849-plan-section" style={{ paddingTop: "clamp(24px, 3vw, 40px)" }}>
          <div className="container">
            ...
            <m.p className="fp1849-plan-desc" {...FADE_IN}>Built for desert living, this single-level home pairs an open great room, island kitchen, and dining area with a covered patio out back. The owner's suite sits privately on its own wing with a spa-style bath and walk-in closet, while two secondary bedrooms and a full bath anchor the other end. A flexible office off the foyer doubles as an optional fourth bedroom. The signature of the plan is its garage: a standard two-car bay plus a dedicated, oversized RV garage with room for a motorhome, boat, or trailer.</m.p>
          ...
          <section className="fp1849-gallery-section alt-bg">
            <div className="container" style={{ paddingTop: "clamp(40px, 6vw, 80px)" }}>
              <m.div className="page-section-head centered" {...FADE_IN}>
                ...
                <p className="fp1849-gallery-body">The 2194 floor plan, built as our Rio Verde RV home in Rio Verde, AZ.</p>
              </m.div>
            </div>
            ...
            <m.div className="fp1849-carousel" {...FADE_IN}>
              <button
                ...
                data-testid="fp2194-carousel-prev"
              >
                <ChevronLeft size={22} />
              </button>
              ...
              <button
                ...
                data-testid="fp2194-carousel-next"
              >
            ...
            <div className="container" style={{ paddingBottom: "clamp(40px, 6vw, 80px)" }}>
              <m.div style={{ textAlign: "center", marginTop: "32px" }} {...FADE_IN}>
                <Link
                  href="/gallery/rio-verde-rv"
                  className="btn btn-primary"
                  data-testid="fp2194-gallery-link"
                >
      ...
      {lightbox !== null && (
        ...
        >
          <button
            ...
            onClick={closeLightbox}
            aria-label="Close"
            data-testid="fp2194-lightbox-close"
          >
            <X size={22} />
          </button>
          <img

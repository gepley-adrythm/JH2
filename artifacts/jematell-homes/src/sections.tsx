    ...
    <section className="hero">
      ...
      <div className="container hero-content">
        <div className="hero-copy">
          <h1 className="heading-xl hero-title" style={{ textTransform: 'uppercase', fontSize: '85px', maxWidth: 'none' }}>
            <span style={{ display: 'block', whiteSpace: 'nowrap' }}>Let's Make Your</span>
            <span style={{ display: 'block', whiteSpace: 'nowrap' }}>Dream a Reality</span>
          </h1>

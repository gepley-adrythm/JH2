      ...
      <div className="container">
        <div className="about-grid" style={{ display: 'block' }}>
          ...
          >
            ...
            <h2 className="heading-lg" style={{ marginBottom: '32px', textTransform: 'uppercase' }}>A family-owned builder for Arizona</h2>
            <p>
    ...
    <section className="featured-projects section-pad">
      <div className="container">
        <m.div {...FADE_IN_UP_PROPS}>
          <h2 className="heading-md featured-projects-heading">Homes We've Built</h2>
        </m.div>

  ...
  return (
    <main className="page">
      <Seo
        ...
        description="How construction-to-permanent financing works in Arizona, with a construction loan calculator to estimate payments and guidance on our preferred lender."
        canonical="/financing"
      ...
      <section className="faq-cta">
        <div className="container faq-cta-inner">
          ...
          <button type="button" className="btn btn-primary" onClick={() => open()} data-testid="financing-cta-contact">

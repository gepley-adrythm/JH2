          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://www.yelp.com/biz/jematell-homes-scottsdale?utm_campaign=www_business_share_popup&utm_medium=copy_link&utm_source=(direct)" aria-label="Yelp" target="_blank" rel="noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M20.16 12.73l-4.703 1.14c-.8.188-1.528-.592-1.2-1.356l1.968-4.484c.356-.812 1.46-.812 1.928-.108l2.736 3.344c.496.604.076 1.48-.728 1.464zm-7.112 4.776l-.688 4.816c-.12.832.784 1.408 1.488.948l4.14-2.628c.704-.448.644-1.508-.104-1.876l-3.452-2.188c-.724-.46-1.632.08-1.384.928zm-4.18-1.972l-4.596 1.628c-.78.276-.84 1.356-.096 1.72l4.38 2.2c.744.372 1.572-.248 1.392-1.056l-.784-3.828c-.184-.892-1.296-1.064-1.296-.664zm-.5-4.044L3.784 9.36c-.828-.12-1.38.8-.948 1.5l2.704 4.368c.432.7 1.484.596 1.768-.172l1.092-3.788c.284-.984-.636-1.876-1.04-1.808zm3.016-7.44C11.384 4 11 3.7 11 3.7V.92C11 .16 10.124-.2 9.624.2L5.836 3.412c-.5.4-.428 1.176.14 1.476l4.816 2.492c.716.372 1.568-.268 1.492-1.072l-.104-1.764z"/>
                </svg>
              </a>

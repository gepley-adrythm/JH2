  ...
  return (
    <main className="page">
      ...
      <section className="dt-section fin-page">
        <div className="container" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", minHeight: "30vh" }}>
          ...
          <div className="fin-steps">
            {steps.map((step, i) => (
              <article key={step.title} className="fin-step">
                ...
                <h3 className="fin-step-title" style={{ fontSize: "20px", color: "#3b617f" }}>{step.title}</h3>
                <p>{step.body}</p>
              </article>
            ))}
          </div>

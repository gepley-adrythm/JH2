...
- `pnpm --filter @workspace/jematell-homes run lint:content:ci` — build first, then run the content lint (this is the registered `content` validation command)
